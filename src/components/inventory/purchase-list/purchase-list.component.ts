import { GetListFormData, PurchaseOrderService } from 'src/services/purchase-order.service';
...
export class PurchaseListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pagePrepare();
    this.authService.initSystemParam().subscribe(ret => {
  ...
  openModal(dataItem) {
    ...
    modalRef.componentInstance.brandDDL = this.systemParams ? this.systemParams.find(p => p.type == 'Brand').values : [];
